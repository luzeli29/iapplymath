...
export default function AnswerBoxOld({correctAnswer,questionFormat,handleSubmitAnswer}) {
    ...
    function handleButtonPress(value) {
        if(value == "←") {
           ...
           setInputAnswer(formatAnswer(questionFormat,inputAnswer).toString().length < 12 ? inputAnswer + value : inputAnswer);
        }
     }
                    ...
                    <table className={style.num_pad_container}>
                        <tbody>
                            ...
                            <td className={style.num_pad_left_box}>
                                <p className={style.num_pad_answer}> <b className={style.num_pad_answer_text}>{formatAnswer(questionFormat,inputAnswer)} </b></p>
                            </td>
                            <td className={style.num_pad_left_box}>
                                {renderButton("✓")}
                            </td>
