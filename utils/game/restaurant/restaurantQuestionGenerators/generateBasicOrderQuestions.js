...
function generateLevel1AQuestions(dishes, order, randomInt) {
  ...
  generatedQuestions.push(
    createGameQuestion(
      {
        en: `Elena’s friend joins you at the table. If all three of you order the same ${randomDishNameEnglish}, what is the total cost of all ${randomDishNameEnglish}? `,
        es: `El amigo de Elena se une a ti en la mesa. Si los tres piden lo mismo  ${randomDishNameSpanish}, ¿cuál es el costo total de todas las ${randomDishNameSpanish}?`,
      },
      answer,
      [
        {
  ...
  let amountWordingAnswer =
    randomNum > 1 ? amountWording.plural : amountWording.singular;

  // create question
  generatedQuestions.push(
    createGameQuestion(
      {
        en: `If you buy your ${randomDishNameEnglish} ${randomNum} ${amountWordingAnswer.en}, how much money would you spend in total?`,
        es: `Si compras tu ${randomDishNameSpanish} ${randomNum} ${amountWordingAnswer.es}, ¿cuánto dinero gastarías en total?`,
      },
      answer,
      [
        {
  ...
  // answer
  answer =
    parseInt(priceOfMainDish) * randomNum1 +
    parseInt(priceOfDessert) * randomNum2;
      ...
      [
        ...
        },
        {
          en:
            ...
            randomNum2 +
            ")  = " +
            priceOfMainDish * randomNum1 +
            priceOfDessert * randomNum2,
          es:
            "(" +
            priceOfMainDish +
            " x " +
  ...
  generatedQuestions.push(
    createGameQuestion(
      {
        en: `Elena’s budget is ${randomNum} dollars. If her main dish costs ${priceOfMainDish} dollars, how many main dishes can she buy?  Please round down to the nearest whole number.`,
        es: `El presupuesto de Elena es de ${randomNum} dólares. Si su ${randomDishNameSpanish} cuesta ${priceOfMainDish} dólares, ¿cuántos platos principales puede comprar? Redondee hacia abajo al número entero más cercano.`,
      },
      answer,
      [
        {
        ...
        {
          en: randomNum + " ÷ " + priceOfMainDish + " = " + answer,
          es: randomNum + " ÷ " + priceOfMainDish + " = " + answer,
        },
      ],
      "wholeNumber"
    )
  ...
  // If your budget is [random # 10-30] dollars, how many desserts can you order?
  ...
  nameOfDessertEnglish = order["dessert"].en;
  nameOfDessertSpanish = order["dessert"].es;
  ...
  generatedQuestions.push(
    createGameQuestion(
      {
        en: `If your budget is ${randomNum} dollars, how many ${nameOfDessertEnglish} can you order?`,
        es: `Si tu presupuesto es de ${randomNum} dólares, ¿cuántos ${nameOfDessertSpanish} puedes pedir?`,
      },
      answer,
      [
        {
  ...
  generatedQuestions.push(
    createGameQuestion(
      {
        en: `How much will you pay for the main dish if you share it with ${randomNum} friends and you all equally split the cost? Round your answer to the nearest hundredth`,
        es: `¿Cuánto pagarás por el plato principal si lo compartes con ${randomNum} amigos y todos comparten el costo por igual? Redondea tu respuesta a la centésima más cercana`,
      },
      answer,
      [
        {
          en: "Step 1: Total number of people eating = friends+1 (you)\nstep 2: Total per person = Main dish Cost / Total # People",
          es: "Paso 1: Número total de personas que comen = amigos+1 (tú)\nPaso 2: Total por persona = Costo del plato principal / Número total de personas",
        },
        {
          en: priceOfMainDish + " ÷ " + totalPeople + " = " + answer,
          es: priceOfMainDish + " ÷ " + totalPeople + " = " + answer,
        },
        {
...
function generateLevel2AQuestions(dishes, order, randomInt) {
  ...
  // Yesterday your parents gave you [range: x = 10-100] dollars to order food at the restaurant. If next time they give you [range = 2-5] times more money, what is your new budget?

  // choose random number between 10 and 100
  randomNum = randomInt(10, 100);
  ...
  generatedQuestions.push(
    createGameQuestion(
      {
        en: `Yesterday your parents gave you ${randomNum} dollars to order food at the restaurant. If next time they give you ${randomNum2} times more money, what is your new budget?`,
        es: `Ayer tus padres te dieron ${randomNum} dólares para pedir comida en el restaurante. Si la próxima vez te dan ${randomNum2} veces más dinero, ¿cuál es tu nuevo presupuesto?`,
      },
      answer,
      [
        {
  ...
  // Today your parents gave you [range: x = 10-100] dollars to order food at the restaurant. If next time they give you a [y= half/third/fourth/fifth/sixth] of today’s amount, what is your new budget?
  ...
  let textT = {
    ...
    // choose random number between 2 and 6
    randomNum2 = randomInt(2, 7);
    ...
    generatedQuestions.push(
        createGameQuestion(
            {
                en: `Today your parents gave you ${randomNum} dollars to order food at the restaurant. If next time they give you ${textT[randomNum2].en} of today’s amount, what is your new budget?`,
                es: `Hoy tus padres te dieron ${randomNum} dólares para pedir comida en el restaurante. Si la próxima vez te dan ${textT[randomNum2].es} de la cantidad de hoy, ¿cuál es tu nuevo presupuesto?`,
            },
            answer,
            [
                {
                    en: randomNum + " ÷ " + randomNum2 + " = ???",
                    es: randomNum + " ÷ " + randomNum2 + " = ???",
                },
                {
                    en: randomNum + " ÷ " + randomNum2 + " = " + answer,
                    es: randomNum + " ÷ " + randomNum2 + " = " + answer,
                },
            ],
            "decimal"
        )
  ...
  generatedQuestions.push(
    createGameQuestion(
      {
        en: `If your budget in 2021 was ${randomNum} dollars, how many ${randomDishNameEnglish} could you afford to buy? Round down to the nearest whole number.`,
        es: `Si tu presupuesto en 2021 fue de ${randomNum} dólares, ¿cuántos ${randomDishNameSpanish} podrías comprar? Redondea hacia abajo al número entero más cercano.`,
      },
      answer,
      [
        {
          en: "Food items = Budget / 2021 Item Price",
          es: "Artículos de comida = Presupuesto / Precio del artículo en 2021",
        },
        {
          en: randomNum + " ÷ " + priceOfDish + " = " + answer,
          es: randomNum + " ÷ " + priceOfDish + " = " + answer,
        },
      ],
      "wholeNumber",
      null,
  ...
  generatedQuestions.push(
    createGameQuestion(
      {
        en: `In 2022 your budget was the same, ${randomNum} dollars. How many ${randomDishNameEnglish} could you buy then? Round down to the nearest whole number.`,
        es: `En 2022 tu presupuesto es el mismo, ${randomNum} dólares. ¿Cuántos ${randomDishNameSpanish} podrías comprar entonces? Redondea hacia abajo al número entero más cercano.`,
      },
      answer,
      [
        {
          en: "Food items = Budget / 2022 Item Price",
          es: "Artículos de comida = Presupuesto / Precio del artículo en 2022",
        },
        {
          en: randomNum + " ÷ " + priceOfDish + " = " + answer,
          es: randomNum + " ÷ " + priceOfDish + " = " + answer,
  ...
  generatedQuestions.push(
    createGameQuestion(
      ...
      [
        {
          en: "What year was the food price the lowest?",
          es: "¿En qué año fue el precio de la comida más bajo?",
        },
        {
          en: "The food price was lowest in 2021, so you can buy the most food in 2021",
          es: "El precio de la comida fue más bajo en 2021, por lo que puedes comprar más comida en 2021",
        },
      ],
      "wholeNumber",
      null,
  ...
  randomDishNameSpanish = plurals[randomDish].es;
  randomDishNameEnglish = plurals[randomDish].en;
  ...
  generatedQuestions.push(
    createGameQuestion(
      ...
      [
        {
          en:
            "Step 1: Calculate food items in 2021 (x) = 28 ÷ " + randomDishNameEnglish+"\n"+ "Step 2: Multiply 2021 food items (x) by " +
            randomDishNameEnglish +
            " = Price to obtain new budget (y)",
          es:
            "Paso 1: Calcula los items de comida del 2021 (x) = 28 ÷ " + randomDishNameSpanish+"\n"+ "Paso 2: Multiplica los items de comida del 2021 (x) por " +
            randomDishNameSpanish +
            " = Precio del nuevo presupuesto  (y)",
        },
        {
...
export default function generateOperationsAndAlgebraQuestions(
  order,
  level,
  randomGenerator
) {
